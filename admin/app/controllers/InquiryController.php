...
class InquiryController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				inquiry.id LIKE ? OR 
				inquiry.name LIKE ? OR 
				inquiry.email LIKE ? OR 
				inquiry.phone LIKE ? OR 
				inquiry.subject LIKE ? OR 
				inquiry.message LIKE ? OR 
				inquiry.inquiry_date LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","email","phone","subject","message","inquiry_date");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","email","phone","subject","message","inquiry_date");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'name' => 'required',
