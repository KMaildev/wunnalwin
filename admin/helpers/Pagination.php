				...
				<form class="mt-3" id="form<?php echo $form_id ?>" action="<?php echo ($this->set_link()); ?>" method="get">
					<div class="row justify-content-center">
						...
						<div class="<?php echo $detail_page_class; ?>">
							...
							?>
									<small class="text-muted"> [html-lang-0088]  : <?php echo $record_position; ?> [html-lang-0126]  <?php echo $this->total_records; ?></small>
							...
							?>
									| <small class="text-muted">[html-lang-0089] : 
										...
										[html-lang-0126] <?php echo $numofpages; ?>
									</small>
							<?php 
								}
						...
						<div class="<?php echo $list_page_class ?>">
							<ul class="pagination pagination-sm">
								...
								if ($page_num != 1) {
									...
									?>
									<li class="page-item">
										<a class="page-link" title="First Page">vradicon[first_page]vradicon</a>
									</li>
									<?php
								}
								...
								if ($page_num != 1) { 
									...
									?>
									<li class="page-item">
										<a class="page-link" title="Previous Page">vradicon[arrow_back]vradicon</a>
									</li>
									<?php
								}
								...
								if ($page_num < $numofpages) { 
									...
									<li class="page-item">
										<a class="page-link" title="Go to Next Page" href="<?php $this->set_link($page_num + 1); ?>">
											vradicon[arrow_forward]vradicon
										</a>
									</li>
									...
									?>
									<li class="page-item">
										<a class="page-link" title="Next Page">vradicon[arrow_forward]vradicon</a>
									</li>
									<?php
								}
								//last button
								if ($page_num >= 1 && $numofpages > 1 && $numofpages!=$page_num) { 
									...
									?>
										<li class="page-item">
											<a class="page-link" title="Last Page" >vradicon[last_page]vradicon</a>
										</li>
									<?php
								}
								?>
