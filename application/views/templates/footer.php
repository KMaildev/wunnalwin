	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-12">
				<div class="footer-logo"><img src="<?php echo base_url(); ?>public/assets/images/footer-logo.png" alt=""></div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-6">
				<div class="copyright">Copyright © 2021 Job Finder - All Rights Reserved.</div>
			</div>
			<div class="col-lg-6 col-md-6">
				<div class="social">
...
<script src="<?php echo base_url(); ?>public/assets/js/bootstrap.bundle.min.html"></script>
<script src="<?php echo base_url(); ?>public/assets/js/owl.carousel.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>public/assets/js/script.html"></script>
</body>
...
<script>
	function myFunction() {
		var x = document.getElementById("navbarScroll");
